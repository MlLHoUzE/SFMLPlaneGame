...
, mStatisticsNumFrames(0)
{
	...
	mTextures.load(Textures::TitleScreen,	"Media/Textures/ts3.jpg");
...
void Application::registerStates()
{
	...
	mStateStack.registerState<level2>(States::level2);	//create the new level states
	mStateStack.registerState<level3>(States::level3);
}
