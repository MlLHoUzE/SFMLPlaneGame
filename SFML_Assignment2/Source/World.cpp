...
void World::update(sf::Time dt, int level)	//added level being passed in
{
...
void World::buildScene(int level)	//pass in the level
{
	...
	// Add enemy aircraft
	addEnemies(level);	//pass level so enemies can be added based on it
}
